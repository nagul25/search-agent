...
class SearchExamples:
    ...
    def example_3_filter_by_capability(self):
        ...
        print("\n1️⃣ Identity & Access Management tools:")
    ...
    def example_5_hybrid_search_with_filters(self):
        ...
        print("\n1️⃣ TEB Approved authentication tools:")
        ...
        print("\n4️⃣ Under Review analytics tools:")
        result = self.search_client.hybrid_search(
            "analytics data",
    ...
    def example_8_complex_filters(self):
        ...
        print("\n1️⃣ Tools from Google OR Microsoft:")
        ...
        print("\n2️⃣ TEB Approved Identity & Access Management tools:")
        result = self.search_client.filter_search(
        ...
        print("\n3️⃣ Non-deprecated DevOps tools:")
        result = self.search_client.filter_search(
        ...
        print("\n4️⃣ Tools with version 3.x or higher:")
        result = self.search_client.filter_search(
            "Version ge '3.0.0'"
        )
        self.print_results(result)
    ...
    def example_10_advanced_queries(self):
        ...
        print("\n1️⃣ TEB Approved tools (selected fields only):")
        result = self.search_client.filter_search(
        ...
        print("\n2️⃣ Google or Microsoft authentication tools:")
        result = self.search_client.hybrid_search(
        ...
        print("\n3️⃣ Tools with 'Azure' in the name:")
